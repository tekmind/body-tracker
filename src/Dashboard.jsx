...
const BASE_STYLES = `
  ...
  @media (hover: hover) {
    .stat-card-clickable:hover { box-shadow: 0 0 0 1px rgba(0, 0, 0, 0.07), 0 0 32px rgba(0, 0, 0, 0.17); }
  }
  .stat-card-clickable:focus-visible { box-shadow: 0 0 0 1px rgba(0, 0, 0, 0.07), 0 0 32px rgba(0, 0, 0, 0.17); outline: 2px solid var(--cut); outline-offset: 2px; }
